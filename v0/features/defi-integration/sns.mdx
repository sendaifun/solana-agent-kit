---
title: '.SOL Domain Services'
description: 'Register and manage .SOL domains using Bonfida Name Service'
---

Register, resolve, and manage .SOL domains using the Solana Name Service (SNS) through Bonfida. Includes domain registration, resolution, and management functionality.
