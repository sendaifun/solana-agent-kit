...
<CardGroup cols={2}>
  ...
  <Card title="Misc Plugin" icon="toolbox" href="/docs/v2/plugins/misc/misc-plugin-intro">
    Use Helius utilities, Alchemy RPC/data/webhook helpers, domains, price feeds, and other integrations.
  </Card>
...
You can use any Solana RPC URL for `YOUR_RPC_URL`. With Alchemy, use:
