...
export class SolanaDeployToken2022Tool extends Tool {
  ...
  description = `Deploy a new token 2022 on Solana blockchain.
  
  Inputs (input is a JSON string):
  name: string, eg "My Token 2022" (required)
  uri: string, eg "https://example.com/token-2022.json" (required)
  symbol: string, eg "MTK22" (required)
